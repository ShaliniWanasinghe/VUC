...
import { Trash2, CheckCircle, XCircle, Edit3, Loader2, AlertTriangle, Calendar, User, Heart, Bell } from 'lucide-react';
                        ...
                        >
                            <div className="flex justify-between items-start gap-4">
                                ...
                                <div className="flex items-start gap-1.5 flex-shrink-0">
                                    {/* User Interactions: Interest & Reminders */}
                                    <button
                                        onClick={async () => {
                                            try {
                                                const res = await api.post(`/notices/${notice._id}/interest`);
                                    ...
                                    <button
                                        onClick={async () => {
                                            try {
                                                const res = await api.post(`/notices/${notice._id}/remind`);
                                                toast.success(res.data.message);
                                            } catch (err) {
                                                toast.error('Failed to set reminder');
                                            }
                                        }}
                                        className="p-1.5 rounded-lg text-gray-400 hover:bg-amber-50 hover:text-amber-500 transition-colors"
                                        title="Remind Me"
                                    >
